...
namespace SV21T1020839.DataLayers.SQLServer
{
    public interface IProductDAL
    {
        ...
        /// <summary>
        /// Lấy danh sách các thuộc tính của mặt hàng, sắp xếp thứ tự của DisplayOrder
        /// </summary>
        /// <param name="productID"></param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        ProductAttribute? GetProductAttribute(long attributeID);
        /// <summary>
        ...
        bool HiddenPhoto(long photoID, bool isHidden);
    }
}
